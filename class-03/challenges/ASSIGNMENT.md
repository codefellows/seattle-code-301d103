...
1. Create a new branch for this challenge called `filter`
   - `git checkout -b filter`
1. Retrieve the code challenge from the system
   - `npm run get-challenge 03`
1. In your terminal, from the `javascript` folder, run `npm test 03` to execute the tests in this file for **this challenge.**
