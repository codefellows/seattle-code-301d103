...
1. Create a new branch for this challenge called `objects`
   - `git checkout -b objects`
1. Retrieve the code challenge from the system
   - `npm run get-challenge 09`
1. In your terminal, from the `javascript` folder, run `npm test 09` to execute the tests in this file for **this challenge.**
